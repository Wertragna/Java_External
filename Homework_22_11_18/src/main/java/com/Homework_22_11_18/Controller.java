...
import com.Homework_22_11_18.command.ActionCommand;
import com.Homework_22_11_18.command.ActionFactory;
...
public class Controller extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ActionCommand command = client.defineCommand(request); //* * вызов реализованного метода execute() и передача параметров * классу-обработчику конкретной команды *//*
